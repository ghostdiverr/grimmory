...
export const routes: Routes = [
  ...
  {path: 'oauth2-callback', component: OidcCallbackComponent},
  {
    ...
    children: [
      ...
      {path: 'wanted-list', loadComponent: () => import('./features/wanted/component/wanted-list/wanted-list.component').then(m => m.WantedListComponent), canActivate: [EditMetadataGuard]},
