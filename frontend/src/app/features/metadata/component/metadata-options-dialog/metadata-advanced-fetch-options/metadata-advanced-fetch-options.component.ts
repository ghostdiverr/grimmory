...
export class MetadataAdvancedFetchOptionsComponent implements OnChanges {
  ...
  providers: string[] = ['Amazon', 'Google', 'GoodReads', 'Hardcover', 'Babelio', 'Comicvine', 'Douban', 'Lubimyczytac', 'Ranobedb', 'Audible'];
  providersWithClear: string[] = ['Clear All', 'Amazon', 'Google', 'GoodReads', 'Hardcover', 'Babelio', 'Comicvine', 'Douban', 'Lubimyczytac', 'Ranobedb', 'Audible'];
